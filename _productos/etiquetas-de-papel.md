...
## Conoce los tipos stickers de papel adhesivo que te ofrecemos en Holographic

### Etiquetas de papel blancas para impresión térmica

{% include videos.html %}

Este tipo de papel autoadhesivo es requerido para el funcionamiento de impresoras térmicas de marcas reconocidas. Además, es crucial en el desarrollo de etiquetas **ZEBRA, TSC, BIXOLON, CAB, DATALOGIC, TSC, HONEYWELL, SAT y etiquetas BROTHER**.

Nuestra presentación en rollo incluye un **amplio portafolio de medidas y materiales** para ajustarse a las necesidades de tu empresa.

A continuación, te mostramos las diferentes etiquetas de papel que puedes encontrar aquí en Holographic:

| 📋 **Tipo de Etiqueta** | 🧾 Material | 🖨️ Impresión | 📦 Usos | Medidas Disponibles |
|-------------|------------------|--------------|-----------|----------------------------|
| 📋 **Etiquetas de transferencia** | 🧾 Papel blanco mate, adhesivo P4 | 🖨️ Cinta cera, permite impresión de códigos de barras | 📦 [Marcación de productos]({% post_url 2024-06-18-marcacion-activos-fijos %} "Marcación activos"), [trazabilidad interna]({% post_url 2024-06-17-trazabilidad-interna %} "Trazabilidad interna"), orden de bodegas, carpetas y mensajería  | 32 mm X 15 mm<br>32 mm X 25 mm<br>50mm X 25 mm<br>30mm X 60mm<br>80mm X 40mm<br>100mm X 25 mm<br>100mm X 50mm<br>100mm X 100mm<br>100mm X 150mm |
| 📋 **Etiquetas térmico directas** | 🧾 Papel blanco mate, adhesivo P4 | 🖨️ No requiere cinta cera, se activa por calor | 📦 Marcación y clasificación de inventarios, códigos de barras, referencias, lotes | 32 mm X 15 mm<br>32 mm X 25 mm<br>50mm X 25 mm<br>30mm X 60mm<br>80mm X 40mm<br>100mm X 25 mm<br>100mm X 50mm<br>100mm X 100mm<br>100mm X 150mm |
| 📋 **Etiquetas térmicas con recubrimiento** | 🧾 Papel blanco mate, adhesivo P4, recubrimiento plastificado | 🖨️ No requiere cinta cera, se activa por calor | 📦 Ideal para alimentos refrigerados, evita deterioro de información impresa | 32 mm X 25 mm<br>30mm X 60mm<br>50mm X 25 mm<br>50mm X 73 mm<br>100mm X 50mm |
| 📋 **Etiquetas politérmicas (Térmico sintéticas)** | 🧾 Película de polipropileno, adhesivo freezer | 🖨️ No requiere cinta cera | 📦 Alimentos o elementos expuestos a congelación, evita deterioro de información impresa | 32 mm X 25 mm<br>30mm X 60mm |
| 📋 **Papel de polipropileno** | 🧾 Material plastificado brillante, blanco o transparente | 🖨️ Cinta resina, ofrece durabilidad en la información impresa | 📦 Muestras de laboratorio, trazabilidad en productos de aseo, cosméticos, adherencia sobre plástico, vidrio, cartón o laminados | 50mm X 25 mm<br>100mm X 50mm |
| 📋 **Etiquetas estampadas y de pre-corte** | 🧾 Papel blanco con acabado holográfico estampado, elementos de seguridad, pre-cortes | 🖨️ Cinta cera para papel mate, cinta resina para polipropileno plastificado | 📦 Productos farmacéuticos, productos naturales y cosméticos | 50mm X 30mm<br>65 mm X 40mm<br>100mm X 50mm |
...
## Cintas de cera para impresión de transferencia de tus adhesivos de papel

**Las cintas de transferencia térmica** son un consumible o insumo para impresoras de etiquetas, su función es **estampar mediante el calor la información** que se requiere imprimir.

[En Holographic te ofrecemos un portafolio](/) con diferentes medidas y colores, disponibles para las diferentes referencias de impresoras.

### Cintas de cera para impresión de transferencia que distribuimos en Holographic

| Tipo de Cinta        | Colores                            | Medidas                                              |
|----------------------|------------------------------------|------------------------------------------------------|
| Cintas de cera       | Negro                              | 110mm X 74 mts<br>110mm X 300mts<br>110mm X 450mts |
|                      | Rojo                               | 110mm X 300mts                                     |
| Cera-resina          | Rojo, verde, azul y negra          | 110mm X 300mts<br>110mm X 450mts                 |
| Cintas de resina     | Negro                              | 55 mm X 300mts<br>110mm X 74 mts<br>110mm X 300mts<br>110mm X 450mts |
|                      | Rojo, blanco, verde y azul         | 55 mm X 300mts<br>110mm X 300mts                  |
